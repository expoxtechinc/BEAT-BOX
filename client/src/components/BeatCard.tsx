...
export function BeatCard({ beat, mode = "grid" }: { beat: Beat; mode?: "grid" | "list" }) {
  return (
    <article className={`beat-card beat-card--${mode}`} data-beat-stream={beat.preview_signed_url ? "available" : "unavailable"}>
      ...
      <div className="beat-card__body">
        ...
        <p className="beat-card__preview-note">Stream the full release. Sign in to save it; downloads require sign-in and, for paid beats, verified entitlement.</p>
